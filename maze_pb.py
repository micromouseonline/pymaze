...
class Maze:
    ...
    def is_exit(self,  cell: Location, heading: int) -> bool:
        ...
        if heading == HDG_NORTH:
            # This is a change to the UKMARSBOT code as it used a bitwise operating for open and closed mazes
            result = walls.north != WALL_PRESENT
        elif heading == HDG_EAST:
...
if __name__ == "__main__":
    ...
    for _ in range(iterations()):
        ...
        distances = maze.flood(maze.goal())
    end_time = millis()
